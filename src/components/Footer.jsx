                ...
                <div className="footer-container d-flex flex-wrap justify-content-between">
                    ...
                    <div className="mb-4" style={{ maxWidth: "260px" }}>
                        ...
                        <p className="text-secondary small">
                            A data-driven vehicle loan and insurance analytics
                            platform helping banks, NBFCs, and insurers make
                            smarter, risk-aware decisions using real-time
                            insights.
                        </p>
                    </div>
                        ...
                        <ul className="list-unstyled small">
                            <li>
                                <NavLink
                                    to="/"
                                    onClick={scrollToTop}
                                    className="text-light text-decoration-none d-block mb-1"
                                >
                                    Home
                                </NavLink>
                            </li>
